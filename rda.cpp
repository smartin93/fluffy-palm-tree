    ...
    do {
        ...
        {lex();
            stmt(); }
                  ...
                  {whileloop ();}
          else if ( nextToken ==  IDENT || nextToken ==  INT_LIT || nextToken ==  FLT_PT)
                  { expr ();} 
           /* else if 
               block (); */
    } while (nextToken != EOF);
...
void error(void)
{
printf("Error - Not in the grammer \n");
...
LEFT_PAREN  ||  nextToken ==  IDENT || nextToken ==  INT_LIT || nextToken ==  FLT_PT || nextToken ==  WHILE_CODE) 
...
else if (nextToken ==  LEFT_PAREN  ||  nextToken ==  IDENT || nextToken ==  INT_LIT || nextToken ==  FLT_PT)
{expr(); }
else if (nextToken ==  WHILE_CODE)
{  whileloop() ; 
       }
...
else if (nextToken !=  LESS_OP  ||  nextToken != MORE_OP || nextToken != LESS_EQUAL_OP || nextToken !=  MORE_EQUAL_OP)
{	error();  }
else if (nextToken ==  BTERM_CODE)
{ error() ; }
  ...
  case LETTER:
    ...
    
    {
      nextToken = IF_CODE;
        ...
        else  if(regex_search(lexeme, regex("ELSE_CODE")))
       {
